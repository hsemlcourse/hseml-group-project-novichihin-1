"""Streamlit UI for the Ad Campaign Profit Predictor.

Sends predictions to the FastAPI backend via HTTP.
...
st.markdown("Предскажите прибыль рекламной кампании по параметрам таргетинга, креатива и аукциона.")
...
with col_left:
    ...
    with c1:
        ...
        campaign_objective = st.selectbox("Objective", ["Lead Generation", "Engagement", "Conversion", "Brand Awareness"])
        industry_vertical = st.selectbox("Industry", ["E-commerce", "Finance", "Gaming", "Healthcare", "Technology", "Education"])
    ...
    with c3:
        ...
        audience_interest_category = st.selectbox("Interest", ["Shoppers", "Business Professionals", "Tech Enthusiasts", "Gamers"])
